...
class NmapParser:
    def __init__(self, localhost_ip="127.0.0.1"):
        ...
        self.added_nodes = set()  # 用于跟踪已添加的节点，避免重复节点
    ...
    def _add_localhost_node(self):
        ...
        self.added_nodes.add(self.localhost_ip)
    ...
    def _parse_host(self, host):
        ...
        if ip_address in self.added_nodes:
            return  # 避免重复添加节点
        ...
        self.added_nodes.add(ip_address)
...
def main():
    # 输入多个 XML 文件路径
    input_files = ["./xml/189.xml", "./xml/190.xml"]  # 替换为实际的 nmap 扫描结果文件路径
